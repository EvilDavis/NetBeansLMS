<%-- 
    Document   : user_search_book
    Created on : 2018-1-18, 8:44:13
    Author     : Acer
--%>
...
<head>
    ...
    <title>user search book page</title>
    ...
    <div class="userinfobox">
        ...
        <div class="row no-gutter">
            ...
            <div class="input-group mb-3" style="width:500px">
                <input type="text" class="form-control" placeholder="请输入书名" aria-label="Recipient's username" aria-describedby="basic-addon2">
