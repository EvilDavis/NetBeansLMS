...
<body>
    ...
    <div class="userinfobox">
        ...
        <div class="row no-gutter">
            ...
            <div>
                <label class="radio-inline">
                    <input type="radio" name="gender" value="教师" checked>教师
                </label>
                <label class="radio-inline">
                    <input type="radio" name="gender" value="学生">学生
                </label>
            </div>
        </div>
        <div class="row no-gutter">
            ...
            <div class="col-60">
                <input type="text" class="form-control" style="width:400px" value="3" placeholder="请输入借书期限">
            </div>
        </div>
        ...
        <div class="row no-gutter">
            ...
            <div class="col-60">
                <input type="text" class="form-control" style="width:400px" value="" placeholder="请输入借书数量">
            </div>
        </div>
        ...
        <div class="row no-gutter">
            ...
            <div class="col-60">
                <input type="text" class="form-control" style="width:400px" value="" placeholder="请输入延期时间">
            </div>
        </div>
        <div class="row no-gutter">
            <div class="col-40 text-r">书目最少数量：</div>
            <div class="col-60">
                <input type="text" class="form-control" style="width:400px" value="2" placeholder="请输入书目最少数量">
            </div>
        </div>
        <div class="row no-gutter">
            <div class="col-25 text-r"> </div>
