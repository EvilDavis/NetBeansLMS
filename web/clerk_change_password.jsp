<%-- 
    Document   : clerk_change_password
    Created on : 2018-1-18, 9:14:07
    Author     : Acer
--%>
...
<head>
    ...
    <title>clerk change password page</title>
...
<body>
    ...
    <div class="userinfobox">
        ...
        <div class="row no-gutter">
            ...
            <div class="col-60">
                <input type="password" class="form-control" style="width:400px" placeholder="请输入原密码">
            </div>
        </div>
        <div class="row no-gutter">
            <div class="col-40 text-r">新密码：</div>
            <div class="col-60">
                <input type="password" class="form-control" style="width:400px" placeholder="请输入新密码">
            </div>
        </div>
        <div class="row no-gutter">
            <div class="col-40 text-r">确认新密码：</div>
            <div class="col-60">
                <input type="password" class="form-control" style="width:400px" placeholder="重复新密码">
            </div>
        </div>
        <div class="row no-gutter">
            <div class="col-25 text-r"> </div>
