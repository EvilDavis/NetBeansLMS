<%-- 
    Document   : change_book_info
    Created on : 2018-1-18, 8:39:39
    Author     : Acer
--%>
...
<body>
    ...
    <div class="userinfobox">
        ...
        <div class="row no-gutter">
            ...
            <div class="col-70">
                <input type="text" class="form-control" style="width:400px" value="傲慢与偏见" placeholder="请输入书本的名称">
            </div>
        </div>
        <div class="row no-gutter">
            <div class="col-30 text-r">ISBN：</div>
            <div class="col-70">
                <input type="text" class="form-control" style="width:400px" value="978-7-02-012144-1" placeholder="请输入书本的ISBN">
            </div>
        </div>
        <div class="row no-gutter">
            <div class="col-30 text-r">出版时间：</div>
            <div class="col-70">
                <input type="date" class="form-control" style="width:400px" value="2000-01-01 00:00:00" placeholder="请输入书本的出版时间">
            </div>
        </div>
        <div class="row no-gutter">
            <div class="col-30 text-r">作者：</div>
            <div class="col-70">
                <input type="text" class="form-control" style="width:400px" value="简·奥斯丁" placeholder="请输入书本的作者">
            </div>
        </div>
        <div class="row no-gutter">
        ...
        <div class="row no-gutter">
            ...
            <div class="col-70">
                <input type="text" class="form-control" style="width:400px" value="79.00" placeholder="请输入书本的单价">
            </div>
        </div>
        <div class="row no-gutter">
            <div class="col-30 text-r">出版社： </div>
            <div class="col-70">
                <input type="text" class="form-control" style="width:400px" value="上海文艺出版社" placeholder="请输入书本的出版社">
            </div>
        </div>
        ...
        <div class="row no-gutter">
            ...
            <div class="col-70">
                <textarea name="" id="" cols="30" rows="3" style="width:400px" placeholder="请输入书本的简介"> 本书描写爱情与婚姻，现实真实地反映了当时农村的阶级关系、风俗习惯和社会心理，衬托出十八世纪至十九世纪初英国保守闭塞的乡村生活。
                </textarea>
            </div>
        </div>
