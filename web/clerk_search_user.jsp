<%-- 
    Document   : clerk_search_user
    Created on : 2018-1-18, 9:07:18
    Author     : Acer
--%>
...
<head>
    ...
    <title>cleck search user page</title>
    ...
    <div class="userinfobox">
        ...
        <div class="row no-gutter">
            ...
            <div class="input-group mb-3" style="width:500px">
                <input type="text" class="form-control" placeholder="请输入用户的姓名" aria-label="Recipient's username" aria-describedby="basic-addon2">
